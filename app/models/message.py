...
class Message(BaseModel):
    ...
    messageUpdatedAt: datetime = Field(default_factory=datetime.utcnow, description="Date and time when the message was last updated")
    ...
    messageCreatedAt: datetime = Field(default_factory=datetime.utcnow, description="Date and time when the message was created")
